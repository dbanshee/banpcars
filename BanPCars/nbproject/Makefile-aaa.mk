...
${OBJECTDIR}/banPCarsDump.o: banPCarsDump.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/banPCarsDump.o banPCarsDump.c

${OBJECTDIR}/banPCarsServer.o: banPCarsServer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/banPCarsServer.o banPCarsServer.c
...
${OBJECTDIR}/pcarsApi.o: pcarsApi.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pcarsApi.o pcarsApi.c

${OBJECTDIR}/serialwin.o: serialwin.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/serialwin.o serialwin.c

${OBJECTDIR}/simController.o: simController.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/simController.o simController.c
