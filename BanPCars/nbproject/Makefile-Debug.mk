...
${OBJECTDIR}/src/BanPCarsDump/banPCarsDump.o: src/BanPCarsDump/banPCarsDump.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BanPCarsDump/banPCarsDump.o src/BanPCarsDump/banPCarsDump.c
...
${OBJECTDIR}/src/BanPCarsServer/pCarsDump.o: src/BanPCarsServer/pCarsDump.c 
	${MKDIR} -p ${OBJECTDIR}/src/BanPCarsServer
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BanPCarsServer/pCarsDump.o src/BanPCarsServer/pCarsDump.c
