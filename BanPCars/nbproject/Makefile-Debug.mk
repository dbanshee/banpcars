...
${OBJECTDIR}/src/libs/ACApi.o: src/libs/ACApi.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I../ext-sources/libmicrohttpd-0.9.38/libmicrohttpd-0.9.38/src/include -I../ext-sources/jansson-2.7/src -include ../ext-sources/jansson-2.7/src/jansson.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/ACApi.o src/libs/ACApi.c
...
${OBJECTDIR}/src/libs/simSource.o: src/libs/simSource.c 
	${MKDIR} -p ${OBJECTDIR}/src/libs
	${RM} "$@.d"
	$(COMPILE.c) -g -I../ext-sources/libmicrohttpd-0.9.38/libmicrohttpd-0.9.38/src/include -I../ext-sources/jansson-2.7/src -include ../ext-sources/jansson-2.7/src/jansson.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/simSource.o src/libs/simSource.c
