...
/* ./.libs/lt-dual_stack_example.c - temporary wrapper executable for .libs/dual_stack_example
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The dual_stack_example program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "dual_stack_example"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# dual_stack_example - temporary wrapper script for .libs/dual_stack_example\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The dual_stack_example program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"dual_stack_example:dual_stack_example:${LINENO}: libtool wrapper (GNU", f);
  fputs (" libtool) 2.4.2 Debian-2.4.2-1.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"dual_stack_example:dual_stack_example:${LINENO}: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"dual_stack_example:dual_stack_example:${LINENO}: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='dual_stack_example'\n", f);
