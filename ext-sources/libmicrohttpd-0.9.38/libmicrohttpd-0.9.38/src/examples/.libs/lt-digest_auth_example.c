...
/* ./.libs/lt-digest_auth_example.c - temporary wrapper executable for .libs/digest_auth_example
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The digest_auth_example program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "digest_auth_example"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# digest_auth_example - temporary wrapper script for .libs/digest_auth_example\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The digest_auth_example program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"digest_auth_example:digest_auth_example:${LINENO}: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"digest_auth_example:digest_auth_example:${LINENO}: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"digest_auth_example:digest_auth_example:${LINENO}: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='digest_auth_example'\n", f);
