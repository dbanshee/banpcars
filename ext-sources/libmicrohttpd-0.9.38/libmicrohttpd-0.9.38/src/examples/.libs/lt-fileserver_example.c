...
/* ./.libs/lt-fileserver_example.c - temporary wrapper executable for .libs/fileserver_example
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The fileserver_example program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "fileserver_example"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# fileserver_example - temporary wrapper script for .libs/fileserver_example\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The fileserver_example program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"fileserver_example:fileserver_example:${LINENO}: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"fileserver_example:fileserver_example:${LINENO}: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"fileserver_example:fileserver_example:${LINENO}: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='fileserver_example'\n", f);
