...
/* ./.libs/lt-fileserver_example_external_select.c - temporary wrapper executable for .libs/fileserver_example_external_select
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The fileserver_example_external_select program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/Documents and Settings/banshee/Mis documentos/NetBeansProjects/BanPCars/ext-sources/libmicrohttpd-0.9.38/libmicrohttpd-0.9.38/src/microhttpd/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/Documents:and:Settings/banshee/Mis:documentos/NetBeansProjects/BanPCars/ext-sources/libmicrohttpd-0.9.38/libmicrohttpd-0.9.38/src/microhttpd/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "fileserver_example_external_select"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# fileserver_example_external_select - temporary wrapper script for .libs/files", f);
  fputs ("erver_example_external_select\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The fileserver_example_external_select program cannot be directly executed un", f);
  fputs ("til all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../../src/microhttpd/libmicrohttpd.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"fileserver_example_external_select:fileserver_example_external_select", f);
  fputs (":${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"fileserver_example_external_select:fileserver_example_external_selec", f);
  fputs ("t:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"fileserver_example_external_select:fileserver_example_external_s", f);
  fputs ("elect:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='fileserver_example_external_select'\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/Documents:and:Settings/banshee/Mis:documentos/NetBeansProj", f);
  fputs ("ects/BanPCars/ext-sources/libmicrohttpd-0.9.38/libmicrohttpd-0.9.38/src/microht", f);
  fputs ("tpd/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/Documents and Settings/banshee/Mis documentos/NetBeansPro", f);
  fputs ("jects/BanPCars/ext-sources/libmicrohttpd-0.9.38/libmicrohttpd-0.9.38/src/microh", f);
  fputs ("ttpd/.libs:$PATH\"\n", f);
  fputs ("\n", f);
