...
/* ./.libs/lt-fileserver_example_dirs.c - temporary wrapper executable for .libs/fileserver_example_dirs
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The fileserver_example_dirs program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "fileserver_example_dirs"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# fileserver_example_dirs - temporary wrapper script for .libs/fileserver_examp", f);
  fputs ("le_dirs\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The fileserver_example_dirs program cannot be directly executed until all the", f);
  fputs (" libtool\n", f);
  ...
  fputs ("    echo \"fileserver_example_dirs:fileserver_example_dirs:${LINENO}: libtool wr", f);
  fputs ("apper (GNU libtool) 2.4.2 Debian-2.4.2-1.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"fileserver_example_dirs:fileserver_example_dirs:${LINENO}: newargv[$", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"fileserver_example_dirs:fileserver_example_dirs:${LINENO}: newar", f);
  fputs ("gv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='fileserver_example_dirs'\n", f);
