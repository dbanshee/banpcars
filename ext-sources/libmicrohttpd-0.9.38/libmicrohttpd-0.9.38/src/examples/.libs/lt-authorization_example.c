...
/* ./.libs/lt-authorization_example.c - temporary wrapper executable for .libs/authorization_example
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The authorization_example program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "authorization_example"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# authorization_example - temporary wrapper script for .libs/authorization_exam", f);
  fputs ("ple\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The authorization_example program cannot be directly executed until all the l", f);
  fputs ("ibtool\n", f);
  ...
  fputs ("    echo \"authorization_example:authorization_example:${LINENO}: libtool wrappe", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"authorization_example:authorization_example:${LINENO}: newargv[$lt_d", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"authorization_example:authorization_example:${LINENO}: newargv[0", f);
  ...
  fputs ("\n", f);
  fputs ("  program='authorization_example'\n", f);
