...
/* ./.libs/lt-benchmark_https.c - temporary wrapper executable for .libs/benchmark_https
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The benchmark_https program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "benchmark_https"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# benchmark_https - temporary wrapper script for .libs/benchmark_https\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The benchmark_https program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"benchmark_https:benchmark_https:${LINENO}: libtool wrapper (GNU libto", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"benchmark_https:benchmark_https:${LINENO}: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"benchmark_https:benchmark_https:${LINENO}: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
