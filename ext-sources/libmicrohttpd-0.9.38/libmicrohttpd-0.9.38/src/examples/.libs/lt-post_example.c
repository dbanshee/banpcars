...
/* ./.libs/lt-post_example.c - temporary wrapper executable for .libs/post_example
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The post_example program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "post_example"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# post_example - temporary wrapper script for .libs/post_example\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The post_example program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"post_example:post_example:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"post_example:post_example:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"post_example:post_example:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
