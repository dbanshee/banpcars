...
/* ./.libs/lt-benchmark.c - temporary wrapper executable for .libs/benchmark
...
const char * TARGET_PROGRAM_NAME = "benchmark"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# benchmark - temporary wrapper script for .libs/benchmark\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The benchmark program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"benchmark:benchmark:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 De", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"benchmark:benchmark:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"benchmark:benchmark:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
