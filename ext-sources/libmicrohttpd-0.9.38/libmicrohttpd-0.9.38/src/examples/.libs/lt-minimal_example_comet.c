...
/* ./.libs/lt-minimal_example_comet.c - temporary wrapper executable for .libs/minimal_example_comet
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The minimal_example_comet program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "minimal_example_comet"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# minimal_example_comet - temporary wrapper script for .libs/minimal_example_co", f);
  fputs ("met\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The minimal_example_comet program cannot be directly executed until all the l", f);
  fputs ("ibtool\n", f);
  ...
  fputs ("    echo \"minimal_example_comet:minimal_example_comet:${LINENO}: libtool wrappe", f);
  fputs ("r (GNU libtool) 2.4.2 Debian-2.4.2-1.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"minimal_example_comet:minimal_example_comet:${LINENO}: newargv[$lt_d", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"minimal_example_comet:minimal_example_comet:${LINENO}: newargv[0", f);
  ...
  fputs ("\n", f);
  fputs ("  program='minimal_example_comet'\n", f);
