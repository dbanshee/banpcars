...
/* ./.libs/lt-minimal_example.c - temporary wrapper executable for .libs/minimal_example
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The minimal_example program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "minimal_example"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# minimal_example - temporary wrapper script for .libs/minimal_example\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The minimal_example program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"minimal_example:minimal_example:${LINENO}: libtool wrapper (GNU libto", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"minimal_example:minimal_example:${LINENO}: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"minimal_example:minimal_example:${LINENO}: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
