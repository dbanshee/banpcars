...
/* ./.libs/lt-responseheaders.c - temporary wrapper executable for .libs/responseheaders
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The responseheaders program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "responseheaders"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# responseheaders - temporary wrapper script for .libs/responseheaders\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The responseheaders program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"responseheaders:responseheaders:${LINENO}: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.2 Debian-2.4.2-1.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"responseheaders:responseheaders:${LINENO}: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"responseheaders:responseheaders:${LINENO}: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
