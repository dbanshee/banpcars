...
/* ./.libs/lt-basicauthentication.c - temporary wrapper executable for .libs/basicauthentication
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The basicauthentication program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "basicauthentication"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# basicauthentication - temporary wrapper script for .libs/basicauthentication\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The basicauthentication program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"basicauthentication:basicauthentication:${LINENO}: libtool wrapper (G", f);
  fputs ("NU libtool) 2.4.2 Debian-2.4.2-1.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"basicauthentication:basicauthentication:${LINENO}: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"basicauthentication:basicauthentication:${LINENO}: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='basicauthentication'\n", f);
