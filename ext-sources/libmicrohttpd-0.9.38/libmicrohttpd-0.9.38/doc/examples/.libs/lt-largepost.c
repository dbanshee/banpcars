...
/* ./.libs/lt-largepost.c - temporary wrapper executable for .libs/largepost
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The largepost program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "largepost"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# largepost - temporary wrapper script for .libs/largepost\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The largepost program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"largepost:largepost:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 De", f);
  fputs ("bian-2.4.2-1.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"largepost:largepost:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"largepost:largepost:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
