...
/* ./.libs/lt-simplepost.c - temporary wrapper executable for .libs/simplepost
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The simplepost program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "simplepost"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# simplepost - temporary wrapper script for .libs/simplepost\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The simplepost program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"simplepost:simplepost:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 ", f);
  fputs ("Debian-2.4.2-1.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"simplepost:simplepost:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"simplepost:simplepost:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
