...
/* ./.libs/lt-hellobrowser.c - temporary wrapper executable for .libs/hellobrowser
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7

   The hellobrowser program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "hellobrowser"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# hellobrowser - temporary wrapper script for .libs/hellobrowser\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7\n", f);
  fputs ("#\n", f);
  fputs ("# The hellobrowser program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"hellobrowser:hellobrowser:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.2 Debian-2.4.2-1.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"hellobrowser:hellobrowser:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"hellobrowser:hellobrowser:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
